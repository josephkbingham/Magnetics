...
- [Self And Mutual Inductance Analogy](./self-and-mutual-inductance-analogy.md): Water-wheel and shared-belt analogy for self-inductance, mutual inductance, coupling coefficient, leakage flux, coupled-coil energy, and the ideal transformer turns-ratio result. [source: User note 2026-07-05]
...
- [Inductor Design Sensitivity](./inductor-design-sensitivity.md): One-variable-at-a-time sensitivity of peak flux density and temperature rise to turns, gap, core scale, current density, and frequency at a defined baseline design point, with an interactive chart companion under `interactive/`. [source: Hurley & Wolfle Ch. 3 §3.1-§3.2] [source: Erickson & Maksimovic Ch. 11 §11.1]
...
[Self And Mutual Inductance Analogy](./self-and-mutual-inductance-analogy.md) sits next to the mechanical analogy page as a lower-barrier explanation of inductive inertia, transformer coupling, leakage flux, and the relation $M = k\sqrt{L_1L_2}$. [source: User note 2026-07-05]
